...
description: Create and refine character GIFs from image-generated keyframes or generated/existing video, with optional image references, Grok video by default and image-keyframe fallback. Includes motion direction, phase-specific timing, chroma-key or alpha processing, alignment, global-palette encoding and decoded-frame QC. Use for animated characters, objects and transparent GIF deliverables; use a sprite skill for intentionally discrete pixel-art animation.
---
